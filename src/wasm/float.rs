...
/// construct distance
pub fn float_create_0(dis: &OrderedFloat<f64>) -> *const OrderedFloat<f64> {
...
/// construct distance
#[wasm_bindgen]
pub fn float_create(value: f64) -> *const OrderedFloat<f64> {
    float_create_0(&OrderedFloat(value))
}

/// increment reference count
#[wasm_bindgen]
pub fn float_retain(float_obj: *const OrderedFloat<f64>) -> usize {
...
#[wasm_bindgen]
pub fn float_release(float_obj: *const OrderedFloat<f64>) -> usize {
    if !float_obj.is_null() {
        unsafe {
...
/// get float value
#[wasm_bindgen]
pub fn float_get_value(float_obj: *const OrderedFloat<f64>) -> Option<f64> {
    if !float_obj.is_null() {
        unsafe { Some((*float_obj).into_inner()) }
    } else {
        None
    }
}
